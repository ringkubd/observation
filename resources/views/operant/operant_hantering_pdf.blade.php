                    ...
                    <div class="tab-content">
                      ...
                      <div id="level{{$loop->iteration}}" class="" style="margin-top: 20px;">             
                          <table class="table main-table teckenekonomi_level_{{$loops=$loop->iteration}}">
                            <tr>
                              <th style="@if($infos->id == '1')background:#c9dff9; @elseif($infos->id == '2') background:#FDE9D9; @else background:#EBF1DD @endif"  colspan="6">Level {{$infos->id}}</th>
                            </tr>

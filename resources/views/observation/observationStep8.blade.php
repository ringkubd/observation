    ...
    <div class="container-fluid">
        ...
        <div class="comment-ob" style="margin-top: 20px">
          ...
          <div class="form-group">  
            <textarea rows="4" class="form-control add_comment" attr_url="{{url('store-observation-comment')}}"  stag="7" client_id="{{$request->client_id}}" branch_id="{{$request->branch_id}}"  company_id="{{$request->company_id}}">{{ $observationComment->input_text ?? null }}</textarea>
          </div> 
        </div>
